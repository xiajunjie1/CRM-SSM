...
<script type="text/javascript">
	...
	$(function(){
		...
		//给退出模态框确定按钮他添加点击事件，请求后台
		$("#logoutConfirm").click(function(){
            window.location.href="/user/logout_handle";
		});
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="position: relative; left: 40px;">
						...
						允许访问IP：<b>${sessionScope.sessionUser.allowIp}</b>
					</div>
				</div>
	...
	<div class="modal fade" id="exitModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="button" class="btn btn-primary" data-dismiss="modal"  id="logoutConfirm">确定</button>
				</div>
			</div>
		</div>
	</div>
			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="/setting/index"><span class="glyphicon glyphicon-wrench"></span> 系统设置</a></li>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				...
				<li class="liClass"><a href="/customer/index" target="workareaFrame"><span class="glyphicon glyphicon-user"></span> 客户</a></li>
				<li class="liClass"><a href="contacts/index.html" target="workareaFrame"><span class="glyphicon glyphicon-earphone"></span> 联系人</a></li>
				<li class="liClass"><a href="/tran/index" target="workareaFrame"><span class="glyphicon glyphicon-usd"></span> 交易（商机）</a></li>
				...
				<li class="liClass">
					...
					<ul id="no2" class="nav nav-pills nav-stacked collapse">
						...
						<li class="liClass"><a href="/chart/tran/toChartIndex" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 交易统计图表</a></li>
					</ul>
				</li>
